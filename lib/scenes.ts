...
export const FACE_PRESERVATION = `CRITICAL: Preserve each person's face, facial features, skin tone, and identity EXACTLY as shown in the original photo. Do not modify face geometry, facial structure, eye shape, nose, mouth, or any facial characteristics. Every person must be immediately recognizable as themselves. If multiple people are present, preserve each individual distinctly.`;
...
export const SUBJECT_ADAPTATION = `Subject adaptation: Match clothing, accessories, and styling to each person's gender presentation and vibe without forcing gendered outfits. Prefer flattering, comfortable, realistic wardrobe choices that suit their body type and style. If multiple people are in the photo, give each person distinct but cohesive styling that fits the scene.`;
...
Add an interesting, fun, or ridiculous hat, headpiece, or hairstyle that matches the vibe of the scene. Make it memorable and photo-worthy. Choose clothing and styling that fits the person naturally and matches their vibe.
...
MANDATORY HAT: Give them an absolutely UNHINGED carnival headpiece - oversized, glowing, and dramatic. Think LED-trimmed crown with spinning light rings, neon feathers, and small marquee bulbs that look like they came off a festival sign. This hat is a STATEMENT. It says "main character energy."

Scene transformation: Dress them in a flamboyant carnival-meets-stage-performer outfit that matches their style - sequined or iridescent layers, bold jewelry with star motifs, and footwear that sparkles like stage lights. Confetti bursts mid-air, fireworks streak across the sky, and a playful parade swirls around them with streamers and balloons. Vary the outfit details (colors, textures, and accessories) to avoid repetition between subjects.

Background: Maximum chaos - a glowing carnival midway with neon arches, ferris wheel lights reflecting in the air, a parade of dancers, and glowing paper lanterns floating above. A neon sign says "NO REGRETS" in bold marquee letters.
...
MANDATORY STYLING: Give them absolutely TRANSCENDENT rave hair - think cyber-goth meets extraterrestrial DJ. Towering neon-colored hair extensions or a dramatic styled look, possibly with cyber dreads or UV-reactive wraps, cyber goggles pushed up on forehead, and LED strip lights woven through. Their face should have subtle UV face paint accents (dots, tribal patterns) that glow. Maybe some chrome/metallic temporary tattoos visible.

Scene transformation: This is a 2003 rave compilation cover come to life. Dress them in peak Y2K rave fashion that matches their vibe - vinyl pants with a mesh top, a sparkly bodysuit, or a cropped jacket with platform cyber boots. Arms absolutely STACKED with kandi bracelets up to the elbow. They're mid-dance move, hands up, eyes closed in pure euphoric bliss, surrounded by laser beams cutting through artificial fog. Mix the color palette and garment silhouettes so each person looks distinct.

Background: A massive outdoor festival at night - think Ibiza beach party meets alien landing. Enormous LED totems, fire dancers as silhouettes, a massive DJ booth with impossible amounts of lasers and pyrotechnics. The crowd is just visible as a sea of glow sticks. The sky has northern lights that are definitely not natural.
...
MANDATORY HAIR: Give them the most LEGENDARY disco hair ever witnessed - a gravity-defying voluminous style that could house a family of birds, big bouncy curls, or a dramatic feathered look that moves in slow motion. The hair should contain at least one hidden mini disco ball, be dusted with actual glitter, and have a small bird or butterfly that seems to have gotten lost in there. This hair has its own agent.

Scene transformation: Peak Studio 54 excess - a sequined jumpsuit or sparkly outfit with a dramatic silhouette, bell-bottoms so wide they qualify as a fire hazard, platform shoes that add 8 inches of pure confidence, and enough gold chains to set off a metal detector from space. They're mid-move on the light-up floor, one finger pointing to heaven, the other holding a martini that somehow hasn't spilled. Vary fabrics, colors, and accessories between people to avoid uniformity.

Background: The most legendary disco club that never existed - a disco ball the size of a Volkswagen raining light everywhere, the floor is pure illuminated tiles, there's a live tiger on a leash in the background (very 70s), velvet ropes, silhouettes of dancers doing the hustle, and enough glamour to fuel a documentary. The vibes are immaculate.
...
Scene transformation: Peak desert radical self-expression - they're wearing something that's either high fashion or completely insane (or both). Think: flowing desert prophet robes, layered scarves, structured vests, utility belts, dramatic faux fur coat despite it being 100 degrees, harness and chains, or artistic body paint with bold accessories - whatever matches their energy. Avoid tight or feminine bodysuits unless it clearly matches the subject's style. Platform boots caked in playa dust. They're posed in front of art, mid-moment of pure transcendence - arms possibly raised, expression of absolute presence and joy. Vary textiles and accessories so everyone looks unique.
...
Scene transformation: Full mer-royalty FANTASY - an iridescent tail in impossible colors that shift from deep purple to electric teal to gold, scales that catch light like a disco ball underwater. Upper body adorned with artistic shell and pearl arrangements that suit their style - could be a dramatic chest piece, elegant draping, or fierce warrior aesthetic. Arms dripping with sea glass jewelry. They're holding a trident that's definitely also a cocktail accessory. Their expression is "I'm the hot one in this ocean and I know it." A dramatically grumpy pufferfish serves as their reluctant sidekick. Vary tail colors and accessories per person.
...
MANDATORY HAIR: The ULTIMATE 80s fitness hair - we're talking crimped, teased, and volumized to the heavens, held back by a sweatband that means BUSINESS. The hair should be so voluminous it needs its own zip code, possibly with a scrunchie that's aggressively neon, and DEFINITELY some sweat glistening because this workout is INTENSE. Bonus: a headband that says something like "NO PAIN NO GAIN" or just aggressive geometric shapes.

Scene transformation: Peak aerobics instructor energy - spandex everything in the most aggressively clashing neon colors possible (think hot pink and lime green leopard print). Could be a leotard, bike shorts with a crop top, or a matching set that screams 1985. Matching leg warmers bunched perfectly, high-top Reeboks that have never seen dirt, and wristbands on both wrists because symmetry. They're frozen mid-aerobic move - maybe a high kick that defies physics, or the classic fist-pump. Their expression says "I WILL OUT-CARDIO GOD." Mix patterns and colorways so each person feels distinct.
...
${STYLE_INSTRUCTIONS} VHS aesthetic - slightly soft, oversaturated neons, maybe some subtle tracking lines. This should look like a freeze-frame from an actual workout tape that everyone's parents owned.`,
  },
  {
    id: "renaissance",
    name: "Royal Renaissance",
    emoji: "🏰",
    prompt: `${FACE_PRESERVATION}
...
Scene transformation: Full Renaissance faire COMMITMENT - outfit should match their vibe: a dramatic doublet with puffy sleeves you could hide multiple turkey legs in, an elaborate corseted gown with ridiculous amounts of fabric, or a roguish bard look with too many accessories. Definitely a ruffled collar so large it's basically a neck satellite dish. They're holding a comically oversized turkey leg in one hand like a scepter and a goblet that's overflowing with... let's say grape juice... in the other. Their expression says "I am the main character of this entire century." Ensure each person has unique colors, accessories, and roles (jester, royal, bard, knight).
...
MANDATORY HEADGEAR: The most CHAOTIC vacation headwear - either a helmet covered in GoPros pointing in every direction, a backwards cap with "SEND IT" embroidered, a completely inappropriate hat for the activity they're doing (like a top hat while skydiving), OR their hair is just WRECKED from whatever extreme thing just happened - windswept, possibly singed slightly, definitely tells a story.

Scene transformation: They're mid-RIDICULOUS vacation activity - maybe they're somehow surfing, skydiving, AND riding a jet ski simultaneously. Wearing a combination of vacation clothes that makes no sense - Hawaiian shirt tucked into a wetsuit, ski goggles with flip-flops, life jacket over formal wear. Their expression is somewhere between "this was a terrible idea" and "I've never felt more alive." They're clutching an umbrella drink that has somehow survived the chaos. Mix the activities and wardrobe mashups for variety.
